...
import net.freelance.android.pets.data.PetDBHelper;
...
public class EditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    private static final int EXISTING_PET_LOADER = 0;/*** Identifier for the pet data loader*/

    private Uri mCurrentPetUri;/** Content URI for the existing pet (null if it's a new pet) */
    ...
    private void setUpSpinner() {
        Log.i(LOG_TAG, "TEST : setUpSpinner() called...");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_delete:// Respond to a click on the "Delete" menu option
                showDeleteConfirmationDialog();// Do nothing for now, Pop up confirmation dialog for deletion
                return true;// Do nothing for now

            case android.R.id.home:// Respond to a click on the "Up" arrow button in the app bar
                //NavUtils.navigateUpFromSameTask(this);//Navigate back to parent activity(CatalogActivity)
    ...
    private void savePet() {
        ...
        //int petWeight = Integer.parseInt(weightString);//Convert String to Integer this way -> (Integer.parseInt("1"); -> 1)
       ...
       /* SQLiteDatabase db = mPetDBHelper.getWritableDatabase();*/
        ...
        // Create a new map of values, where column names are the keys, and pet attributes from the editor are the values.
       ...
       /* // Insert the new row, returning the primary key value of the new row
        ...
        //Log.i(LOG_TAG, "TEST : New Row ID " + newRowId);*/
    }
